...
//  .-----------------------------------------------------.                    .-----------------------------------------------------.
     KC_TAB,   KC_Q,    KC_W,    MAC_E,    KC_R,    KC_T,                        KC_Y,    MAC_U,   MAC_I,  MAC_O,   KC_P,  KC_BSPC,
//  |--------+--------+--------+--------+--------+--------|    /* _MACOS */    |--------+--------+--------+--------+--------+--------|
...
//  '--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------'
                        MT(KC_LCMD, KC_TAB), MT(SYMB, CMDTAB), KC_SPC,    KC_SPC, MT(NUMP, KC_ENT), KC_ALGR
                                      //'--------------------------'  '--------------------------------'
  ),
    ...
    */
    ...
    [_SYMB] = LAYOUT_split_3x6_3(
        //  .-----------------------------------------------------.                    .-----------------------------------------------------.
        KC_ESC, KC_EXLM, ALGR(KC_1), KC_HASH, KC_DOLLAR, KC_PERC, KC_AMPR, KC_HOME, KC_UP, KC_END, XXXXXXX, KC_DEL,
        //  |--------+--------+--------+--------+--------+--------|     /* _SYMB */    |--------+--------+--------+--------+--------+--------|
    ...
    */
    ...
    [_NUMP] = LAYOUT_split_3x6_3(
        ...
        //  '--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------'
        MT(KC_LCMD, KC_TAB), MT(SYMB, KC_ENT), KC_ENT, KC_SPC, _______, KC_ALGR
        //'---------------------------------'  '--------------------------'
        ),
    ...
    */
    ...
    [_TUNE] = LAYOUT_split_3x6_3(
        ...
        //  '--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------'
        MT(KC_LCMD, KC_TAB), _______, KC_SPC, KC_ENT, _______, KC_ALGR
        //'--------------------------'  '--------------------------'
        )};
...
static void master_logo(void) {
    static const char PROGMEM crkbd_logo[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc0, 0xe0, 0xf0, 0xf8, 0xf8, 0x18, 0x00, 0xc0, 0xf0, 0xfc, 0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xf8, 0xfc, 0xfe, 0xff, 0xe0, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x80, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x1f, 0x07, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x0f, 0x1f, 0x3f, 0x3f, 0x3f, 0x3f, 0x1f, 0x1f, 0x3f, 0x3f, 0x7f, 0x7f, 0x7f, 0x3f, 0x3f, 0x1f, 0x3f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7c, 0x78, 0x78, 0x38, 0x1c, 0x0f, 0x00, 0x00};
...
static void slave_logo(void) {
    static const char PROGMEM corne_logo[] = {0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87, 0x88, 0x89, 0x8a, 0x8b, 0x8c, 0x8d, 0x8e, 0x8f, 0x90, 0x91, 0x92, 0x93, 0x94, 0xa0, 0xa1, 0xa2, 0xa3, 0xa4, 0xa5, 0xa6, 0xa7, 0xa8, 0xa9, 0xaa, 0xab, 0xac, 0xad, 0xae, 0xaf, 0xb0, 0xb1, 0xb2, 0xb3, 0xb4, 0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc5, 0xc6, 0xc7, 0xc8, 0xc9, 0xca, 0xcb, 0xcc, 0xcd, 0xce, 0xcf, 0xd0, 0xd1, 0xd2, 0xd3, 0xd4, 0};
